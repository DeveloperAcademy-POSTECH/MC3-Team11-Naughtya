...
extension Color {
    ...
    static let customGray3 = Color(red: 0.31, green: 0.31, blue: 0.31)
    static let customGray4 = Color(red: 0.23, green: 0.23, blue: 0.23)
    static let customGray5 = Color(red: 0.18, green: 0.18, blue: 0.18)
    static let customGray6 = Color(red: 0.13, green: 0.13, blue: 0.13)
